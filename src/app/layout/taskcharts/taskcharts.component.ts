...
@Component({
    selector: 'app-taskcharts',
    templateUrl: './taskcharts.component.html',
    styleUrls: ['./taskcharts.component.scss'],
    animations: [routerTransition()]
})
export class TaskchartsComponent implements OnInit, OnDestroy {
